...
/* harmony import */ var _floating_ui_dom_esm_eabd20d7_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17775);
...
const loadModule = (cmpMeta, hostRef, hmrVersionId) => {
    ...
    if (!hmrVersionId || !BUILD.hotModuleReplacement) {
      ...
      switch(bundleId) {
        ...
        case 'dyte-pip-toggle':
          return __webpack_require__.e(/* import() */ 1001).then(__webpack_require__.bind(__webpack_require__, 41180)).then(processMod, consoleError);
        ...
        case 'dyte-spotlight-indicator':
          return __webpack_require__.e(/* import() */ 3182).then(__webpack_require__.bind(__webpack_require__, 63457)).then(processMod, consoleError);
    ...
    return __webpack_require__(9657)(`./${bundleId}.entry.js`).then((importedModule) => {
        {
            cmpModules.set(bundleId, importedModule);
        }
        return importedModule[exportName];
