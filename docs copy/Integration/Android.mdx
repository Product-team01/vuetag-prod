...
You will need your sdk token for initializing your library. You can get your sdk token from [sdk settings](https://supportdocs.vuetag.ai/api/#/).
...
Have any questions? Reach out to MSD [Support]( support@vue.ai) to speak to someone smart, quickly.
